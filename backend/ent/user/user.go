...
const (
	...
	CheckinLogsTable = "checkin_logs"
	// CheckinLogsInverseTable is the table name for the CheckinLog entity.
	// It exists in this package in order to avoid circular dependency with the "checkinlog" package.
	CheckinLogsInverseTable = "checkin_logs"
	// CheckinLogsColumn is the table column denoting the checkin_logs relation/edge.
	CheckinLogsColumn = "user_id"
