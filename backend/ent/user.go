...
type UserEdges struct {
	...
	CheckinLogs []*CheckinLog `json:"checkin_logs,omitempty"`
...
// was not loaded in eager-loading.
func (e UserEdges) CheckinLogsOrErr() ([]*CheckinLog, error) {
	if e.loadedTypes[13] {
...
// QueryCheckinLogs queries the "checkin_logs" edge of the User entity.
func (_m *User) QueryCheckinLogs() *CheckinLogQuery {
	return NewUserClient(_m.config).QueryCheckinLogs(_m)
}
